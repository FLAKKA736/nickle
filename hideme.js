...
document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('answers.json')
      ...
      function OpenEdretard(){
        window.open("edpuzzle.html", "_self");
      };
      function OpenStudyretard(){
        window.open("answers.html", "_self");
      };
      function OpenGimKitretard(){
        window.open("gimkit.html", "_self");
      };
